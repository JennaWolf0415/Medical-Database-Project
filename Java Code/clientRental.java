...
//file: ClientRental.java
//purpose: panel used for clients to make rental orders. Also tells clients when they can make an order if
//they aren't able to make it for the set dates because of quantity constraints.
...
public class ClientRental extends javax.swing.JFrame {
    int idNum;  //holds the id num from the last page (so we know what user is logged in)
    
    public ClientRental(int idNum) {
        this.idNum = idNum;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(endDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 170, 40));
        jPanel2.add(startDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 170, 40));
        ...
        jLabel3.setText("Make sure to include spaces!");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, -1, -1));
        ...
        jPanel2.add(RentButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 290, 260, 40));
        ...
        jPanel2.add(goBackButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 320, 100, 30));

        jLabel6.setFont(new java.awt.Font("Sitka Display", 1, 36)); // NOI18N
        jLabel6.setText("Rent a Piece Of Equipment");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        quanData.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                quanDataActionPerformed(evt);
            }
        });
        jPanel2.add(quanData, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 120, 150, 40));

        jLabel7.setFont(new java.awt.Font("Sitka Display", 1, 34)); // NOI18N
        jLabel7.setText("Equipment:");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, -1, -1));
    ...
    private void RentButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
        try {
            ...
            if(equipment == null || equipment.isEmpty() || quanTest == null || quanTest.isEmpty() || sDate == null || eDate == null) {
                JOptionPane.showMessageDialog(null, "ERROR: You need to provide data to all feilds!");
                return;
            }
            
            //makes sure quantity is a number. if not, error message is given.
            int quan = 0;
            try {
            ...
            if(!eDate.after(sDate)) {
                ...
                if(possible) {
                    ...
                    while(rs.next()) {
                        int currentID = rs.getInt("rental_id");
                        if(newID == currentID) {
    ...
    private void quanDataActionPerformed(java.awt.event.ActionEvent evt) {                                         
